...
例如，如果使用 Microsoft Entra ID，则可以按照 Microsoft 文档中的步骤进行操作link:https://learn.microsoft.com/en-us/entra/fundamentals/add-custom-domain["使用 Microsoft Entra ID 添加域"]。
