...
* link:task-install-connector-google-bluexp-gcloud.html#agent-permissions-google["设置标准模式的 Google Cloud 权限"]
...
* link:task-install-connector-google-bluexp-gcloud.html#agent-permissions-google["了解如何设置服务帐户"]
