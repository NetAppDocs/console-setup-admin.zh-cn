...
* https://docs.netapp.com/us-en/console-setup-admin/task-install-connector-aws-manual.html["在 AWS 中手动安装控制台代理"]
* https://docs.netapp.com/us-en/console-setup-admin/task-install-connector-azure-manual.html["在 Azure 中手动安装控制台代理"]
* https://docs.netapp.com/us-en/console-setup-admin/task-install-connector-google-manual.html["在 Google Cloud 中手动安装控制台代理"]


--
.限制模式
--
https://docs.netapp.com/us-en/console-setup-admin/task-prepare-restricted-mode.html["准备在受限模式下部署"]
