...
使用从安装的 NetApp Console 代理本地提供的基于浏览器的界面。您无法从 SaaS 应用程序提供的基于 Web 的控制台访问 NetApp Console。
...
NOTE: 4.0.0 版之前的 Console 代理支持不同的端点。如果您升级到 4.0.0 或更高版本，则可以从允许列表中删除旧端点。link:reference-networking-saas-console-previous.html["了解有关 4.0.0 之前版本所需的网络访问的更多信息。"]
