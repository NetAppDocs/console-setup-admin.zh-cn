...
.结果
您批准的合作伙伴关系现在显示为 *已建立* 状态。在任何一个组织中具有 *合作伙伴管理员* 或 *合作伙伴查看器* 角色的用户都可以查看合作伙伴关系。
...
. 选择*管理>身份和访问*。
. 选择“*合作伙伴关系*”选项卡。
. 选择 *Initiated partnerships* 或 *Received partnerships* 选项卡。
. 查看显示合作关系及其状态的相应表格。
