...
[role="lead"]
您的 NetApp Console 组织有名称和 ID。您可以为您的组织选择一个名称来帮助识别它。您可能还需要知道用于 API 调用的组织 ID。
...
+
image:screenshot-iam-edit-organization.png["显示操作图标和\"编辑组织\"选项的组织页面的屏幕截图。"]
