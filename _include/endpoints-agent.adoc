...
|===
a| https://bluexpinfraprod.eastus2.data.azurecr.io https://bluexpinfraprod.azurecr.io https://occmclientinfragov.azurecr.us （限制模式部署所需） a| 获取 Console 代理升级所需的映像。

a| https://occmclientinfragov.azurecr.us a| 获取用于 Console 代理升级的映像。
