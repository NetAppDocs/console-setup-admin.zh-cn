...
从控制台或代理维护控制台对控制台代理运行配置检查，以确保它们可以访问所需的端点，并且所需的端口已打开。

您还可以使用代理维护控制台运行配置检查。link:reference-agent-maint-console-config-checker.html["了解更多关于使用 config-checker validate 命令的信息。"]
