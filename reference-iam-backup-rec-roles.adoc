...
* *Backup and Recovery backup admin*：在 NetApp Backup and Recovery 中执行备份到本地快照、复制到辅助存储以及备份到对象存储的操作。
* *备份和恢复还原管理员*：使用 NetApp Backup and Recovery 还原工作负载。
* *Backup and Recovery 克隆管理员*：使用 NetApp Backup and Recovery 克隆应用程序和数据。
