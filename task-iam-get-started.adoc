...
您需要 *Org admin* 或 *Super admin* 权限才能管理组织的身份和访问权限。使用 *Folder or project admin* 权限，您只能管理您具有访问权限的文件夹和项目。
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["五"] 验证您的组织（可选）
[role="quick-margin-para"]
如果您的团队使用组织验证，请将 Console 组织与 NetApp 业务账户身份关联。

[role="quick-margin-para"]
link:task-verify-organization.html["了解如何验证您的组织"]。

.相关信息
* link:concept-identity-and-access-management.html["了解NetApp Console中的身份和访问管理"]
* link:concept-verified-organization.html["了解 NetApp Console 中已验证的组织"]
