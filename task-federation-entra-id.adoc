...
您可以设置与 Microsoft Entra ID 的联合连接，以启用 Console 的单点登录 (SSO)。该过程包括将您的 Microsoft Entra ID 配置为信任 Console 作为服务提供商，然后在 Console 中创建连接。
...
+
*** 对于 *重定向 URL*，请使用 `https://services.cloud.netapp.com`
