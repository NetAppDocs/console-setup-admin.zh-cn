...
summary: NetApp控制台通过控制台代理和Cloud Volumes ONTAP支持 IMDSv2。大多数情况下，IMDSv2 会在新的 EC2 实例上自动配置。 IMDSv1 于 2024 年 3 月之前启用。如果您的安全策略需要，您可能需要在 EC2 实例上手动配置 IMDSv2。 
---
...
* 对于从控制台或使用 https://docs.netapp.com/us-en/bluexp-automation/automate/overview.html["Terraform 脚本"^]，IMDSv2 在 EC2 实例上默认启用。
