...
---
= 从 Azure Marketplace 创建 NetApp Console 代理
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.开始之前
* link:concept-agent-install-options.html#agent-marketplace-deploy["了解何时从 Azure Marketplace 进行部署"]。
...
确保计划安装 Console 代理的网络位置支持以下要求。这些要求使 Console 代理能够管理混合云中的资源。
...
.结果
您现在已安装 Console 代理并使用 Console 组织对其进行了设置。
